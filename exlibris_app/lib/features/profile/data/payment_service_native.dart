...
class PaymentService {
  ...
  Future<String?> createPaymentIntent(int amount, String currency) async {
    try {
      ...
      debugPrint('Erreur createPaymentIntent: $e');
      return null;
    }
  }
  ...
  Future<bool> makePayment(int amount, String currency) async {
    try {
      ...
      debugPrint('Erreur makePayment: ${e.message}');
      debugPrint('StripeConfigException hashCode: ${e.hashCode}');
      return false;
    } catch (e) {
      debugPrint('Erreur makePayment: $e');
      return false;
    }
  }
}
